...
#define OBJECTNAME (char *) "Object"

#define EQUALTEST   "equality_test"
#define DISPABORT   "_dispatch_abort"
#define CASEABORT1  "_case_abort"
#define CASEABORT2  "_case_abort2"

#define LASTPARAMOFFSET 3

#define OBJCLASSTAG  0
#define IOCLASSTAG   1
#define INTCLASSTAG  2
#define BOOLCLASSTAG 3
#define STRCLASSTAG  4
#define MAINCLASSTAG 5

#define NUM_PRED_CLASSES 5
